                ...
                <div className="row">
                    ...
                    <div className="col-6">
                        ...
                        <div className="row">
                            ...
                            <p>Interest is levied at 18% a year or 0.05% per day on the debit balance in your trading , <a href="https://support.zerodha.com/category/console/ledger/articles/interest-charges">Learn more.</a></p>
                        </div>
                        <div className="row">
